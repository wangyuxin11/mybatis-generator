...
Date: 2018-06-05 15:04:10
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `sys_flow_tsf_inr`
-- ----------------------------
DROP TABLE IF EXISTS `sys_flow_tsf_inr`;
CREATE TABLE `sys_flow_tsf_inr` (
