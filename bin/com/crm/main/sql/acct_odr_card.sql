...
Date: 2018-06-05 15:00:46
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `acct_odr_card`
-- ----------------------------
DROP TABLE IF EXISTS `acct_odr_card`;
CREATE TABLE `acct_odr_card` (
  ...
  `fee_amt` decimal(17,2) DEFAULT NULL COMMENT '当状态为“2：已计费”时才有值',
