...
Date: 2018-06-05 15:03:55
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `sys_flow_opp_ext`
-- ----------------------------
DROP TABLE IF EXISTS `sys_flow_opp_ext`;
CREATE TABLE `sys_flow_opp_ext` (
